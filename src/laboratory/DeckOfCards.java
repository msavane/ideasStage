...
public class DeckOfCards {
    ...
    private static ArrayList getNewDeck() {
        ...
        System.out.println(newDeckOfCards.size()-2 + " cards , win when suits or symbols matches !");
    ...
    private static void compareCards(String pc, String player) {
        ...
        for (int i = 0;
            ...
            if (searchMe.regionMatches(i, findMe, 0, findMeLength)) {
                foundIt = true;
                System.out.println(searchMe.substring(0, i + findMeLength) + " WIN");
                System.out.println("you WIN !! Flabola© EIGHT");
                System.out.println(newDeck.size() + " cards left");
                printDeck(newDeck);
                System.exit(0);
